...
BEGIN_MESSAGE_MAP(CTemperatureApp, CWinAppEx)
...
CTemperatureApp::CTemperatureApp()
{
	...
	SetAppID(_T("Temperature.AppID.NoVersion"));
...
BOOL CTemperatureApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_TemperatureTYPE,
...
// CTemperatureApp customization load/save methods

void CTemperatureApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTemperatureApp::LoadCustomState()
{
}

void CTemperatureApp::SaveCustomState()
{
}
